      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="componentTitle text-center">
            <div class="titleBtn">
              <span class="titleBtnInside font-bold">{{
                $t("competitionTitle.title2")
              }}</span>
            </div>
          </div>
        </div>
        ...
        <div class="col-xs-12">
          ...
          <table>
            ...
            <tr>
              <td></td>
              <td>
                (Every finalist must play the final round in a live performance,
                if you are not from the listed country, please email us to
                schedule a live performance time)
              </td>
            </tr>
            <tr>
